                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>A</td>
                      <td>Tetap</td>
                       <td><button id="nilai" data-toggle="modal" data-target="#modal-default" type="button" class="btn btn-block btn-warning"> Nilai Ulang</button>
                      </td>
                      <td><button id="tetap"  type="button" class="btn btn-block btn-success">Tetapkan</button>
                      </td>
